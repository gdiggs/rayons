# RailsAdmin config file. Generated on February 23, 2013 20:49
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Rayons', 'Admin']
  ...
  #     configure :format, :text 
  #     configure :condition, :text 
  #     configure :price_paid, :text 
